...
const ToastNotification: React.FC<{
  ...
  return (
    <div className="fixed top-4 right-4 z-50 animate-slide-in-right">
      <div className="bg-white border border-green-200 rounded-lg shadow-2xl p-4 max-w-sm w-full flex items-center gap-3 transform transition-all duration-300 ease-out">
  ...
  const downloadAllCroppedImages = useCallback(async () => {
    ...
    if ("showDirectoryPicker" in window) {
      try {
        ...
        showToastNotification(
          `${croppedImages.length} images téléchargées avec succès !`
        );
      } catch (error) {
        if ((error as Error).name === "AbortError") {
          // User cancelled, no notification needed
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 sm:p-8 font-inter text-gray-800">
      <div className="max-w-5xl mx-auto">
        <div className="bg-white rounded-xl shadow-2xl p-4 sm:p-8 mb-6 border border-blue-100">
          {!activeImage ? (
            ...
            >
              ...
              <label
                htmlFor="imageInput"
                className="inline-flex items-center px-8 py-3 bg-blue-600 text-white font-semibold rounded-full cursor-pointer hover:bg-blue-700 transition-all duration-300 ease-in-out shadow-lg transform hover:scale-105 text-sm sm:text-lg"
              >
        ...
        <div className="bg-white rounded-xl shadow-2xl p-4 sm:p-8 border border-blue-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-sm sm:text-base text-gray-700">
            <div className="text-center bg-blue-50 p-4 rounded-lg shadow-sm">
              ...
              <p>Upload your image(s) by clicking or dragging and dropping.</p>
            </div>
            <div className="text-center bg-blue-50 p-4 rounded-lg shadow-sm">
              <div className="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center mx-auto mb-3 text-lg font-bold">
                2
            ...
            <div className="text-center bg-blue-50 p-4 rounded-lg shadow-sm">
              ...
              <p>Adjust the crop frame by moving and resizing it.</p>
            </div>
            <div className="text-center bg-blue-50 p-4 rounded-lg shadow-sm">
              <div className="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center mx-auto mb-3 text-lg font-bold">
                4
              </div>
              <p>Click Crop Image to generate the preview.</p>
            </div>
            <div className="text-center bg-blue-50 p-4 rounded-lg shadow-sm">
              <div className="bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center mx-auto mb-3 text-lg font-bold">
                5
              </div>
              <p>Name and download the file—it will be saved automatically.</p>
            </div>
          </div>
        </div>
      </div>
